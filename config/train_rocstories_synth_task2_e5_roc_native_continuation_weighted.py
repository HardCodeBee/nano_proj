"""
Task 2 E5 ROC-native Stage 1: continuation-aware synthetic polish on ROCStories-native rewrites.
"""
...
wandb_run_name = "task2-e5-roc-native-synth-continuation-weighted"

dataset = "rocstories_synth_roc_native"
