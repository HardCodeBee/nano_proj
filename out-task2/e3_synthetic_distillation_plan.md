...
short-story corpus generated by a stronger model, then distill that corpus into the small
checkpoint before a final ROCStories polish.
...
- a cleaner prompt-aligned synthetic corpus has a better chance of changing story-level behavior than another tiny sampler tweak

## Pipeline

### Stage A: generate prompt-aligned synthetic stories
...
- this generator now prioritizes opening-sentence adherence over simple ROCStories style imitation
- accepted outputs must stay aligned with the source opening sentence
